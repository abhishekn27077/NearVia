                ...
                <div className="p-4 rounded-2xl bg-rose-950/20 border border-rose-500/30 space-y-3">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 rounded-lg bg-rose-600 hover:bg-rose-500 text-xs font-bold text-white disabled:opacity-50 cursor-pointer"
                    >
                ...
                <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-3">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-xs font-bold text-white disabled:opacity-50 cursor-pointer"
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center space-x-2.5">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-slate-200">{userData.phone || "None linked"}</div>
                  </div>
                </div>
                <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center space-x-2.5">
