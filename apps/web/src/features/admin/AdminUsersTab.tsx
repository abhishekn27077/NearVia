                  ...
                  <tr key={u.id} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="py-3.5 px-5 text-right">
                      <button
                        ...
                        className="px-3.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-[11px] font-black transition-all shadow-xs"
                      >
                        Manage
                      </button>
                    </td>
        ...
        <div className="p-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-medium">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              disabled={page === 1}
              className="p-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 disabled:opacity-30"
            >
