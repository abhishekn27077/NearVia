        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-md p-6 sm:p-8 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setActiveDispute(null)} className="text-slate-400 hover:text-slate-700">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-2xl bg-orange-600 hover:bg-orange-700 text-xs font-black text-white disabled:opacity-50 shadow-md shadow-orange-600/20 transition"
              >
