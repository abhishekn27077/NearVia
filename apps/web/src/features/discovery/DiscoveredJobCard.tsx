      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 text-xs">
        ...
        <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
          ...
          <div className="font-extrabold text-slate-900 mt-0.5">
            {opportunity.durationHours} {language === "kn" ? "ಗಂಟೆ" : language === "hi" ? "घंटे" : "Hours"}
          </div>
        </div>
        ...
        <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100">
          ...
          <div className="font-extrabold text-slate-900 mt-0.5 truncate flex items-center space-x-1.5">
            <span className="truncate">{opportunity.businessName || opportunity.providerName || "Employer"}</span>
